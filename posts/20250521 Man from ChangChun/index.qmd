...
When I was married, my Korean was at a level similar to a 귀환선교사.^[帰還宣教師, a returned missionary].

I was more comfortable speaking in English.
But Sister K spoke only in Korean.

I did have an advantage of growing up in a Korean home, however, my language skills were limited to a vocabulary of a teenager speaking to parents
...
A Celestial Esperanto.[^4]

[^4]: Esperanto is a constructed international auxiliary language created in 1887 by L.L. Zamenhof with the goal of facilitating communication between people from different linguistic backgrounds. It is designed to be easy to learn and use, with a simple and regular grammar, and vocabulary largely borrowed from European languages. While not an official language of any country, Esperanto is spoken by an estimated 2 million people worldwide.
...
The one without grammar or vocabulary. 
The one that is location independent or dialect-free.

That method of communication will be action based. 
With occasional confirmation, using our countenance, both as means of transmitting and receiving messges.
